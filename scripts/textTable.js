let textTable = [    
  ...
  },  
  {
    ...
    subtitle: "Affiche de film",
    date: "11 2020",
    explications: "Cette affiche a été réalisée dans le cadre d'un travail pour M Lignel (culture de l'image).<br>Ce travail consiste à la réalisation d'une affiche pour le film « Demain », un documentaire sur la crise écologique et économique post 2008, à l'occasion de sa sortie sur Netflix.<br>Cette affiche doit reprendre le style graphique du mouvement constructiviste, qui est un courant qui puise sa source dans la révolution russe et par conséquent qui met en avant l'industrie qui était en plein essor.<br>C'est le juste équilibre entre ses deux notions plutôt opposées que j'ai essayé de trouver. En mettant en avant, de façon quasi propagandiste, les solutions présentées dans le film pour répondre aux problèmes actuels.",
  },
  {
  ...
  },
  {
    ...
    date: "05 2020",
    explications: "Lors de la création d'une marque de nombreux logos sont créés, certaines idées ne donnent aucune suite, mais d'autres sont reprises et développées. <br>Cette planche comporte les différentes propositions de logos pour la marque Simon Laks que nous devions développer pour un projet de Communication lors de ma première année. <br>Ainsi que plusieurs propositions pour mon propre logo. Les logos retenus sont les deux au centre.",
  },  
  {
    imgName: "Folio.jpg",
    projectName: "Projet 8",
    subtitle: "Portfolio de mes autres créations",
    date: "04 2020",
    explications: "Mon portfolio répertorie tous les projets de développement web que j'ai réalisés depuis que je suis à Hetic. <br>Cliquez sur mon nom à droite pour y accéder. -->",
  }
]